...
//Back to main button and restart button
		level.innerHTML+=`<div id = "restart" class = "game-buttons" onclick = "Restart();">reset</div><div id = "home" class = "game-buttons" onclick = "ShowMenu();"> exit</div><div id = "moves"> move ${moves}</div>`;
	}
}
...
function Won() {
	...
	won=true;
	//console.log("hello");
	level.innerHTML = `<div id="won"> 🏆 You win</div><div id = "restart" class = "game-buttons" onclick = "Restart();"> Reset </div><div id = "home" class = "game-buttons" onclick = "ShowMenu();">the list</div>`;
}
